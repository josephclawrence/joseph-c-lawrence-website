...
var SYSPRO_VB = {
    ...
    init: function () {
        sysproInterop.getModel("", function (dataout) {
            ...
            sysproInterop.getAvailableFields(
		        function (fields_data) {
		                ...
		                schema: {
		                    data: function (response) {
		                        ...
		                        var results = $.map(response, function (obj, index) {
		                            if (index != "Charts" && index != "CardsAvailable" && index != "LinksAvailable" && index != "SYSPROKeyData" && index != "TilesAvailable") {
		                                function formatFields(obj) {
		                                    ...
		                                    for (var key in obj) {
		                                        ...
		                                        var fieldPath = key;
		                                        //var fieldPath = Object.keys(obj)[i];
		                                    ...
		                                    for (var key in obj) {
		                                        if (obj.hasOwnProperty(key)) {
		                                            ...
		                                            if (fieldCategory === "Charts") {
		                                                ...
		                                                var caption = getCaption(fieldObject);
		                                                var formattedFieldPath = fieldPath.split(' ').join('_');
		                                                itemsString += '<li class="list-group-item field-name" id="' + formattedFieldPath + '" data-bind="dataPath: selected.FieldPath" data-field-path="Fields.' + fieldPath + '">' + caption + '</li>';
		                                                chartCount++;
		                                            }
		                                        }
		                                    }
		                            ...
		                            function formatFields(obj) {
		                                ...
		                                for (var key in obj) {
		                                    if (obj.hasOwnProperty(key)) {
		                                        ...
		                                        itemsString += '<li class="list-group-item field-name" id="' + formattedDescription + '" data-bind="linkListField: selected.KeyAction" data-key-field="' + keyField + '" data-key-action="' + keyAction + '" data-description="' + description + '">' + description + '</li>';
		                                    }
		            ...
		            SYSPRO_VB.fieldsListDataSource.read().then(function () {
		                ...
		                $(".fieldsPanelBar .list-group-item").on("click", function (event) {
		                    $(this).addClass("active");
		                    var currentItem = $(this);
		                    $(this).parents(".fieldsPanelBar").find(".list-group-item").each(function (index) {
		            ...
		            SYSPRO_VB.chartfieldsListDataSource.read().then(function () {
		                ...
		                $("#chart-fields-list .list-group-item").click(function (event) {
		                    $(this).addClass("active");
		                    var currentItem = $(this);
		                    $(this).parents(".fieldsPanelBar").find(".list-group-item").each(function (index) {
		                        $(this).not(currentItem).removeClass("active");
		                ...
		                $("#chart-fields-list-edit-window .list-group-item").click(function (event) {
		                    $(this).addClass("active");
		                    var currentItem = $(this);
		                    $(this).parents(".fieldsPanelBar").find(".list-group-item").each(function (index) {
		                        $(this).not(currentItem).removeClass("active");
		            ...
		            SYSPRO_VB.linksListDataSource.read().then(function () {
		                ...
		                $(".fieldsPanelBar .list-group-item").click(function (event) {
		                    $(this).addClass("active");
		                    //$(this).find("input").prop("checked", true).attr('checked', 'checked').change();
		                    var currentItem = $(this);
		            ...
		            if (fields_data.hasOwnProperty('CardsAvailable')) {
		                ...
		                if (fields_data.CardsAvailable.Card.length) {
		                    ...
		                    function processCards() {
		                        ...
		                        var cardHTMLObject = SYSPRO_VB.setupFinalLayoutWidget("", WidgetName, "", "Card", "MaxiCard", false, 0, 0, 9, 8, "Joined", "", "", "", WidgetType, ParentFieldPath, 9, 9, 0);
		                        console.log(cardHTMLObject);
		                        console.log(cardHTMLObject.toJSON());
		                        console.log(JSON.stringify(cardHTMLObject.toJSON()));
            ...
            SYSPRO_VB.loadIconJSON(function (response) {
                ...
                console.log("loadIconJSON:" + console.log(response));
               ...
               // console.log(icon_JSON);
                ...
                $.each(icon_JSON, function (key, value) {
                    ...
                    iconHTML += '<label class="btn btn-radio btn-icon"><input type="radio" name="icon_option" id="" value="' + iconName + '" autocomplete="off"><i class="material-icons">' + iconName + '</i></label>';
                    editDataIconHTML += '<label class="btn btn-radio btn-icon"><input data-bind="checked: selected.Icon.Name" type="radio" name="icon_option" id="" value="' + iconName + '" autocomplete="off"><i class="material-icons">' + iconName + '</i></label>';
                    editLayoutIconHTML += '<label class="btn btn-radio btn-icon"><input data-bind="checked: selected.Icon" type="radio" name="icon_option" id="" value="' + iconName + '" autocomplete="off"><i class="material-icons">' + iconName + '</i></label>';
                });
    ...
    dataWindowOpen: function () {
        ...
        $("#dataWindow .btn-primary").off().on('click', function () {
            ...
            var newKendoWidget = SYSPRO_VB.setUpDataWidget("#dataWindow");
    ...
    tileWindowOpen: function () {
        ...
        $('#addTileButtonPopoverWrap').popover({
            ...
            placement: 'top',
            delay: { "show": 100, "hide": 100 },
            content: "Select and configure tiles to proceed"
        });
        ...
        var section = $('div[data-guid="' + SYSPRO_VB.layout_widget_guid + '"] a[data-row="0"]');
        $("#non-tiles-addition").hide();
        $("#tiles-addition").show();

        $("#tileWindow .radio-btn-group .btn-radio").on("click", function (event) {

            $(this).parents(".tile").addClass("selected-tile");
            //$("#linklist_link_text").val($(this).data("description"));
            if (SYSPRO_VB.dataValidator.validate()) {
                // If the form is valid, the Validator will return true
        ...
        $(".deselect-tile").off().on("click", function () {
            if ($(this).parents(".tile").hasClass("selected-tile")) {
                $(this).parents(".tile").removeClass("selected-tile");
                $(this).parents(".tile").find("input").prop("checked", false);
                $(this).parents(".tile").find(".material-icons.text-muted").show();
                $(this).parents(".tile").find(".material-icons.text-success").hide();
            }
        });
        ...
        $("#tileWindow .btn-primary").off().on('click', function () {
            ...
            $(".selected-tile").each(function (index) {
                var tileWidth = $(this).find("input:checked").val();
                console.log(tileWidth);
                var Id1 = sysproInterop.generateUUID();
                var Id2 = sysproInterop.generateUUID();
                var newTileWidget = new dataWidgetModel({
                    "Id": Id1,
                    /* 					"ProductID" : getRandomInt(1, 40), */
                    "Title": index,
                    "FieldName": " Telephone",
                    "FieldPath": "Fields.ARSPENL7Telephone",
                    "HasSmartTag": false,
                    "DataType": "A",
                    "KeyField": undefined,
                    "KeyAction": undefined,
            ...
            /*
sysproInterop.getHtmlFromModel("Widget", targetLayoutWidget.toJSON(), function (result) {
	            var newWidgetHTMLjQuery = $($.trim(result));
				newWidgetHTMLjQuery.find(".sys-tbl").removeClass("sys-tbl").addClass("tile-widget");
	            SYSPRO_VB.column.find(".sortable-list").prepend(newWidgetHTMLjQuery);
	
	            $("#tileWindow .tile").each(function () {
		            $(this).removeClass("selected-tile");
	                $(this).find(".btn-radio").removeClass("active");
...
*/
    ...
    initEditRemoveDataWidget: function () {
        ...
        $(".panel.sys-widget:not(.sys-carousel) .panel.sys-widget .data-widget-options .col-xs-6:last-child i, .panel.sys-widget:not(.sys-carousel) .table td:last-child .data-widget-options i, .panel.sys-widget:not(.sys-carousel) .list-group .data-widget-options .col-xs-6:last-child i").popover({
            html: true,
            placement: "left",
            trigger: "manual",
            animation: false,
        ...
        $(".panel.sys-widget.sys-carousel .panel.sys-widget .data-widget-options .col-xs-6:last-child i").popover({
            ...
            animation: false,
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><div class="popover-content"></div></div>',
            //container: $(this).parents(".sys-carousel"),
            content: '<ul class="nav nav-pills"><li><a class="edit-section"><i class="material-icons text-primary">edit</i></a></li><li><a class="remove-section"><i class="material-icons text-danger">delete</i></a></li></ul>'
        })
	    .on("click", function () {
	        var _this = this;
    ...
    endDragWidget: function (widget) {
        ...
        if (widget.action === 'remove') {
            ...
            if (widget.item.hasClass("quickAddWidget")) {
                ...
                var newLayoutWidget = SYSPRO_VB.setupFinalLayoutWidget("", widgetType, "", Type, SubType, false, DisplayStyle, 0, 9, 8, "Joined", "", "", "", CardTypeDetail, ParentFieldPath, 9, 0);
    ...
    finishQuickDragWidget: function (widget) {
        ...
        var newLayoutWidget = SYSPRO_VB.setupFinalLayoutWidget("", widgetType, "", Type, SubType, false, DisplayStyle, 0, 9, 8, "Joined", "", "", "", CardTypeDetail, 9, 0);
    ...
    previewLayoutWidgetHTML: function (currentRowWindow) {
        ...
        sysproInterop.getHtmlFromModel("Widget", SYSPRO_VB.previewLayoutWidget[1].toJSON(), function (result) {
            ...
            SYSPRO_VB.sizeTiles();
            //sysproInterop.performBind(SYSPRO_VB.fieldsDisplayViewModel.dataSource.at(0).toJSON(), true);
            //sysproInterop.performBind(SYSPRO_VB.bindableFieldsData, false, currentRowWindow + " .layout-widget-preview");
    ...
    setupRowWindow: function (currentRowWindow) {
        ...
        $(currentRowWindow + " input[name='row_options']").on("change", function () {
            ...
            if (SYSPRO_VB.layoutValidator.validate()) {
                // If the form is valid, the Validator will return true
        ...
        $("#tile_layout_section").on("click", function () {
        ...
        function changeLayoutOptions(Widget_Type, General_Type) {
            ...
            if ((Widget_Type != "line_chart_widget" && Widget_Type != "column_chart_widget") || $("#chart-fields-list .list-group-item.active").length) {
        ...
        $(currentRowWindow + " input[name='border_options'], " + currentRowWindow + " input[name='widget_collapsible'], " + currentRowWindow + " input[name='widget_title_text_colour'], " + currentRowWindow + " input[name='widget_title_background_colour'], " + currentRowWindow + " input[name='layout_widget_title'], " + currentRowWindow + " input[name='listview_striped_rows'], " + currentRowWindow + " input[name='card_colour'], " + currentRowWindow + " input[name='chart_colour'], " + currentRowWindow + " input[name='linklist_compact'], " + currentRowWindow + " input.tile-row-column-layout, " + currentRowWindow + " input[name='tile_border_colour']").on("change", function (e) {
            ...
            /*
	            ...
	            $(currentRowWindow + " input[name='layout_widget_title']").val("");
            }
*/
        ...
        $(currentRowWindow + " #chart-fields-list .list-group-item").on("click", function () {
            SYSPRO_VB.previewLayoutWidgetHTML("#rowWindow");
    ...
    setupEditRowWindow: function (currentRowWindow) {
        ...
        $(currentRowWindow + " input[name='border_options'], " + currentRowWindow + " input[name='widget_collapsible'], " + currentRowWindow + " input[name='widget_title_text_colour'], " + currentRowWindow + " input[name='widget_title_background_colour'], " + currentRowWindow + " input[name='layout_widget_title'], " + currentRowWindow + " input[name='listview_striped_rows'], " + currentRowWindow + " input[name='card_colour'], " + currentRowWindow + " input[name='chart_colour'], " + currentRowWindow + " input[name='linklist_compact']").on("change", function (e) {
    ...
    setupLayoutWidget: function (currentRowWindow) {
        ...
        if (document.querySelector(currentRowWindow + ' input[name="icon_option"]:checked') !== null) {
            console.log("has icon");
            Icon = document.querySelector(currentRowWindow + ' input[name="icon_option"]:checked').value;
        }
        if (document.querySelector(currentRowWindow + ' input[name="card_colour"]:checked') !== null) {
            ...
            if (CardBackground == 0 || CardBackground == 2 || CardBackground == 4 || CardBackground == 8 || CardBackground == 7) {
                CardColor = 9;
            } else {
                CardColor = 8;
            }
        ...
        var kendoLayoutWidget = SYSPRO_VB.setupFinalLayoutWidget(currentRowWindow, WidgetName, Title, TypeName, SubType, Collapsible, DisplayStyle, Border, TitleBackground, TitleForeground, Joined, Striped, FieldName, FieldPath, CardTypeDetail, ParentFieldPath, CardBackground, CardColor, ChartColor, BackgroundColor, Icon);
        console.log(WidgetName);
        console.log(kendoLayoutWidget);
        //Rob: Use the Id instead of the uid.
    ...
    setupFinalLayoutWidget: function (currentRowWindow, WidgetName, Title, TypeName, SubType, Collapsible, DisplayStyle, Border, TitleBackground, TitleForeground, Joined, Striped, FieldName, FieldPath, CardTypeDetail, ParentFieldPath, CardBackground, CardColor, ChartColor, BackgroundColor, Icon) {
    ...
    insertLayoutWidget: function (currentRowWindow, GUID, widgetObject) {
        ...
        console.log("finish insertLayoutWidget");

    },

    // Helper function to 
    setUpDataWidget: function (parentWindow) {

        var TextColour, TextSize, TextWeight, TextAlign, DataBackground, IconOption, IconColour, IconAlign, IconSize, Title, HasSmartTag, DataType, KeyField, KeyAction;
        ...
        if (document.querySelector(parentWindow + ' input[name="icon_option"]:checked') !== null) {
            IconOption = document.querySelector(parentWindow + ' input[name="icon_option"]:checked').value;
        }
    ...
    insertDataWidget: function (dataGUID, widgetObject, column_num, widget_index, row_num, section_num, section, parentGUID) {
        ...
        sysproInterop.getHtmlFromModel("Widget",
			...
			function (result) {
			    ...
			    //sysproInterop.performBind(SYSPRO_VB.bindableFieldsData, false, null, section.parent().parent());
    ...
    initNormalSorting: function () {
        ...
        $('.sortable-list').each(function (index) {
            ...
            sortableWidgets[index] = $(this).kendoSortable({
                ...
                ignore: ".data-section, .data-section>div, .data-section *, .tile-widget, .tile, .tile-widget *",
                cursor: "move",
        ...
        $('.data-section').each(function (index) {
            sortableDataWidgets[index] = $(this).kendoSortable({
                ...
                start: function (widget) {
                    ...
                    console.log(widget.draggableEvent.originalEvent.srcElement.parentElement);
                    ...
                    console.log('data widget end event');
                    console.log(widget.action);
                    $(".pulse").each(function () {
                        $(this).removeClass("pulse");
                    });
    ...
    destroyDataSorting: function (sortableDataWidgets) {
        for (i = 0; i < sortableDataWidgets.length; i++) {
            console.log(sortableDataWidgets[i]);
    ...
    onExpandQuickAddFieldsList: function (e) {
        setTimeout(function () {
            console.log("expand");
            console.log($(e.item).parents('.fields-wrapper').height());
    ...
    selectFieldFromSearch: function (item) {
        ...
        if (SYSPRO_VB.openWindow === 'dataWindow') {
            ...
            var currentItem = $("#initial-fields-list-data-window.fieldsPanelBar .list-group-item[data-field-path='" + item.fieldpath + "']");
            ...
            SYSPRO_VB.editDataWindowPanelBar.collapse($("li"));
            SYSPRO_VB.editDataWindowPanelBar.clearSelection();
            var currentItem = $("#initial-fields-list-data-edit-window.fieldsPanelBar .list-group-item[data-field-path='" + item.fieldpath + "']");
            currentItem.addClass("active");
            currentItem.parents(".fieldsPanelBar").find(".list-group-item").each(function (index) {
                $(this).not(currentItem).removeClass("active");
            });
        ...
        $(".tile-widget").each(function (index) {
            ...
            $(this).kendoSortable({
                ...
                change: function (e) {
                    ...
                    tileWidget.children.at(0).children.insert(e.newIndex, dataItem);
                    SYSPRO_VB.sizeTiles();
                }
            });
        });
    ...
    sizeTiles: function () {
        $(".tile").height($(".tile.col-sm-4").first().width());
        $(".carousel").height($(".tile.col-sm-4").first().width() - 4);
        $(".item").height($(".tile.col-sm-4").first().width() - 4);
    },
    ...
    loadIconJSON: function (callback) {
        ...
        //xobj.open('GET', 'fonts/MaterialIcons-Regular.ijmap', true); // Replace 'my_data' with the path to your file
