  ...
  <div class="rules-group-header"> \
    <div class="btn-group pull-right group-actions"> \
      <button type="button" class="btn btn-xs btn-success" data-add="rule"> \
        <i class="material-icons sys-txt-xs">{{= it.icons.add_rule }}</i> {{= it.translate("add_rule") }} \
      </button> \
      {{? it.settings.allow_groups===-1 || it.settings.allow_groups>=it.level }} \
        <button type="button" class="btn btn-xs btn-success" data-add="group"> \
          <i class="material-icons sys-txt-xs">{{= it.icons.add_group }}</i> {{= it.translate("add_group") }} \
        </button> \
      {{?}} \
      {{? it.level>1 }} \
        <button type="button" class="btn btn-xs btn-danger" data-delete="group"> \
          <i class="material-icons sys-txt-xs">{{= it.icons.remove_group }}</i> {{= it.translate("delete_group") }} \
        </button> \
      {{?}} \
    </div> \
    ...
    {{? it.settings.display_errors }} \
      <div class="error-container"><i class="material-icons sys-txt-xs">{{= it.icons.error }}</i></div> \
    {{?}} \
  </div> \
  ...
  <div class="rule-header"> \
    <div class="btn-group pull-right rule-actions"> \
      <button type="button" class="btn btn-xs btn-danger" data-delete="rule"> \
        <i class="material-icons sys-txt-xs">{{= it.icons.remove_rule }}</i> {{= it.translate("delete_rule") }} \
      </button> \
    </div> \
  </div> \
  {{? it.settings.display_errors }} \
