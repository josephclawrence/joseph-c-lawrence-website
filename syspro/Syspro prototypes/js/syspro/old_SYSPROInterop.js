        ...
        try {
            ...
            if (itemOut && !itemOut.ErrorMessage) {
                ...
                $(prefixSelector + " .sparkline-widget", selectorItem).each(function (index) {
                    sysproInterop.hideShowSparklineSeries(this);
                });
    ...
    }catch(ex)
{
        ...
        $.each($(".sparkline-widget-chart:visible"), function (index) {
            ...
            if (chartSelected.data("kendoChart")) {
              ...
              //  kendo.resize($(this));
                ...
                sysproInterop.hideShowSparklineSeries(chartSelected.closest(".sparkline-widget")[0], chartItem);
            }
        });
    },
    ...
    hideShowSparklineSeries: function (sparklineContainer, chart) {
        var series1visible = sparklineContainer.dataset.series1visible === "true";
        var series2visible = sparklineContainer.dataset.series2visible === "true";
        var series3visible = sparklineContainer.dataset.series3visible === "true";
        var series4visible = sparklineContainer.dataset.series4visible === "true";
        var refreshrequired = true;
        if (!chart) {
            refreshrequired = false;
            chart = $(".sparkline-widget-chart", $(sparklineContainer)).data("kendoChart");
        }
    ...
    callLayerWithData: function (dataIn) {
        ...
        if (callLayerInterop.interopType === "SYSPRORehostedBrowser") {
            ...
            if (dataIn.Operation === "logMessage") {
                ...
                $.ajax({
                    url: "http://172.20.10.10/UXTools/api/UXInteropWeb/CallFromScript",
                    data: dataIn
